...
from NeighboursList import NeighboursList
from ConnectedComponents import ConnectedComponents
from ReportTopNConnectedComponents import ReportTopNConnectedComponents
...
def main():
    ...
    N = 6
    ReportTopNConnectedComponents(C, N, authors_df)
