            ...
            <DialogContent>
                <form>
                    <Grid container spacing={2} sx={{ padding: 1 }}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <TextField type='number' inputProps={{ min: 1, max: 10, step: 0.1 }} label="Rating" value={movie.rating} onChange={(e) => setMovie({ ...movie, rating: e.target.value ? parseFloat(e.target.value) : 1 })} />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={3}>
