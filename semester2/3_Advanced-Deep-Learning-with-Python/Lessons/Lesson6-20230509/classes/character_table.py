...
class CharacterTable:
    """The CharacterTable class which encapsulates the following functionality: 
    Given a set of characters:

    [1]: Encode them to a one-hot integer representation.

    [2]: Decode the one-hot or integer representation to their corresponding character output.
    ...
    def decode(self, X, calc_argmax=True):
        """This method converts the given vector or 2D array to their character output.
        # ---------------------------------------------------------------------
        # Input Arguments:
