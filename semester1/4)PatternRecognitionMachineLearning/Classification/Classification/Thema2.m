...
X = double(X); % Matrix X is a uint8 array that must be converted to a double array.
X = X ./ 255;  % Normalize the pixel values in the [0 1] interval.
...
net = newff(P,T,[20 10 5 1],{'tansig' 'tansig' 'tansig' 'purelin'});
init(net);
